...
(astraSmoothScroll = function (e, t) {
  ...
  (astScrollToTopHandler = function (e, t) {
    var a = getComputedStyle(t).content,
      s = t.dataset.onDevices,
      a = a.replace(/[^0-9]/g, "");
    "both" == s || ("desktop" == s && "769" == a) || ("mobile" == s && "" == a)
      ? ((s = window.pageYOffset || document.body.scrollTop),
        e && e.length
  ...
  (function () {
      ...
      var t,
        ...
        i =
                    ...
                    if (
                      ...
                      if (void 0 === a) t.style.display = "none";
                        ...
                        for (o = 0, r = s.length; o < r; o++)
                          s[o].addEventListener("focus", u, !0),
                            s[o].addEventListener("blur", m, !0),
                            s[o].addEventListener("click", d, !0);
                      }
                    }
                  }
                })(e[t]);
          ...
          /trident/i.test(a[1])
            ? (g = /\brv[ :]+(\d+)/g.exec(t) || [])
            : ("Chrome" === a[1] &&
                null != (g = t.match(/\bOPR|Edge\/(\d+)/))) ||
              ((a = a[2]
                ? [a[1], a[2]]
                : [navigator.appName, navigator.appVersion, "-?"]),
              null != (g = t.match(/version\/(\d+)/i)) && a.splice(1, 1, g[1]),
              (t = document.body),
              "Safari" === a[0] &&
                a[1] < 11 &&
    ...
    if (
      ...
      "querySelector" in document &&
        ...
        ((s = document.body).addEventListener("mousedown", function () {
          s.classList.add("ast-mouse-clicked");
        }),
        s.addEventListener("keydown", function () {
          s.classList.remove("ast-mouse-clicked");
        })),
      ...
      if (g) for (const v of g) "" !== v.hash && v.addEventListener("click", h);
      function h(e) {
        let t = 0;
